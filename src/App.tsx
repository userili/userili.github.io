...
function Photo({ photo, index }: PhotoProps): JSX.Element {
  return (
    <div
      key={photo.id}
      className='flex w-[150px] h-[150px] items-center justify-start rounded-lg'
      style={{
    ...
    <>
      ...
      {/* {!isLoading && (
        <div className='grid gap-4 grid-cols-2 grid-rows-3'>
          {data.slice(0, 100).map((photo: any, index: number) => (
